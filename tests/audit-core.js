...
const PAGES = [
  ...
  "about.html", "books.html", "editorial.html", "404.html",
  // Generated by scripts/build.js. Present after `npm run build`; the crawl
  // reports a 404 for them if the build has not been run, which is itself the
  // thing worth knowing.
  "topics/health/", "ages/0-1-month/"
];
const VIEWPORTS = {
