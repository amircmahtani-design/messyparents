/* Retired endpoint — superseded by generate-illustration-background.js
...
exports.handler = async () => ({
  ...
  body: JSON.stringify({
    error: "This endpoint is retired. Use /.netlify/functions/generate-illustration-background instead."
  })
});
