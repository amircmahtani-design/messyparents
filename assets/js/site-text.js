...
window.SITE_TEXT = {
  ...
  home: {
    ...
    fields: [
      ...
      { key:"results.filteredMore", label:"Results heading — filters on, more than fit", js:true,
        default:"Top matching guides",
        help:"Used instead of the line above when there are more matches than the four cards can show." },
